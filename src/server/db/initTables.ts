...
const TABLES: Array<{ name: string; ddl: string }> = [
  ...
  // ── Tabelas antes criadas apenas manualmente no banco — DDL extraído do schema
  //    real para garantir paridade em ambientes novos (evita ORA-00942). ────────
  {
    ...
    ddl: `CREATE TABLE MONT_AGENDA_CANDIDATOS (
      ...
      CREATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
      UPDATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
      CONSTRAINT PK_MONT_AGENDA_CANDIDATOS PRIMARY KEY (NUMPED)
    )`,
  },
  {
    ...
    ddl: `CREATE TABLE MONT_ASSEMBLY_REWORKS (
      ...
      CREATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
      ORIGINAL_PROVIDER_ID VARCHAR2(36),
      NEW_PROVIDER_ID VARCHAR2(36),
      NUMPED VARCHAR2(50),
      CODCLI VARCHAR2(50),
      SAC_CASE_ID VARCHAR2(36),
      CLASSIFICATION VARCHAR2(50),
      SEVERITY VARCHAR2(20) DEFAULT 'MEDIA',
      REQUIRES_RETURN NUMBER(1) DEFAULT 0,
      AFFECTS_PROVIDER_SCORE NUMBER(1) DEFAULT 0,
      AFFECTS_PAYMENT NUMBER(1) DEFAULT 0,
      PROCEDENTE NUMBER(1),
      CUSTOMER_COMMENT VARCHAR2(2000),
      SAC_COMMENT VARCHAR2(2000),
      CREATED_BY VARCHAR2(36),
  ...
  {
    name: "MONT_JOB_QUEUE",
    ddl: `CREATE TABLE MONT_JOB_QUEUE (
  ...
  {
    name: "MONT_MSG_INBOUND_LOGS",
    ddl: `CREATE TABLE MONT_MSG_INBOUND_LOGS (
      ID VARCHAR2(36) PRIMARY KEY,
      PROVIDER VARCHAR2(20) NOT NULL,
      FROM_NUMBER VARCHAR2(50) NOT NULL,
      MESSAGE_BODY CLOB,
      WAMID VARCHAR2(200),
      PAYLOAD_JSON CLOB,
...
const NEW_COLUMNS: ColumnDef[] = [
  ...
  { table: "MONT_EVAL_RESPONSES", column: "SAC_CASE_ID", ddl: "VARCHAR2(36)" },
